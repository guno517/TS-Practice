...
var View = function () {
  ...
  View.prototype.setTemplateDate = function (key, value) {
...
exports.NEWS_URL = "https://api.hnpwa.com/v0/news/1.json"; // 해커 뉴스 news 1페이지

exports.CONTENT_URL = "https://api.hnpwa.com/v0/item/@id.json"; // @id를 통해 뉴스 기사 고유의 id를 파악해 해당 뉴스 기사의 json을 가져온다
...
var NewsDetailView = function (_super) {
  ...
  function NewsDetailView(containerId, store) {
    ...
    _this.render = function (id) {
      ...
      _this.setTemplateDate('currentPage', String(_this.store.currentPage.toString()));

      _this.setTemplateDate('title', title);

      _this.setTemplateDate('content', content);

      _this.setTemplateDate("comments", _this.makeComment(comments));
...
var NewsFeedView = function (_super) {
  ...
  function NewsFeedView(containerId, store) {
    ...
    _this.render = function (page) {
      ...
      _this.setTemplateDate("news_feed", _this.getHtml());

      _this.setTemplateDate("prev_page", String(_this.store.prevPage));

      _this.setTemplateDate("next_page", String(_this.store.nextPage));

      _this.updateView();
    };

    _this.store = store;
    _this.api = new api_1.NewsFeedApi(config_1.NEWS_URL); // 클래스 인스턴스
...
var Store = function () {
  ...
  Store.prototype.if = function (feed) {
    feed.read = true;
  };
